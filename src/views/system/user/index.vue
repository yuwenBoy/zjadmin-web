    ...
    <div class="head-container">
      <div class="content-box box-shadow">
        ...
        <el-table ref="table" :data="crud.data" stripe @selection-change="crud.selectionChangeHandler">
          ...
          >
            <template slot-scope="scope">
              <div v-if="!scope.row.avatar" style="width:32px;height:32px;border-radius:16px;background:#0cded4;line-height:32px;text-align:center;font-size:12px;color:#fff;border:1px solid #0cded4;"
              >
                ...
                <el-image v-else
                  :src="'http://localhost:81/img/avatar/' + scope.row.avatar"
                  :preview-src-list="['http://localhost:81/img/avatar/' + scope.row.avatar]"
                  fit="contain"
                  lazy
                  class="el-avatar"
                >
