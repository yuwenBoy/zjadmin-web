  ...
  <div class="app-container">
    <div class="head-container">
      <div class="content-box box-shadow">
        <el-tabs v-model="crud.params.status" @tab-click="handleClick">
          <!-- 公告列表 -->
          <el-tab-pane v-authority="['news:list_0']" label="公告列表" name="0">
            <div class="text item">
              <el-row :gutter="24">
                <el-col :span="10">
            ...
            <el-table ref="table" :data="crud.data" stripe @selection-change="crud.selectionChangeHandler">
              ...
              <el-table-column prop="title" width="120" label="公告标题" align="center" />
              <el-table-column prop="type" width="120" label="公告类型" align="center">
                <template slot-scope="scope">
                  <span>{{ $enum.noticeType[scope.row.type] }}</span>
                </template>
              </el-table-column>
              ...
              <el-table-column label="操作" align="left" width="170">
                <template slot-scope="scope">
                  ...
                  <el-link type="info" :underline="false" @click="toDelete(scope.row)">删除</el-link>
          ...
          <!-- 待审核列表（包含审核不通过） -->
          <el-tab-pane v-authority="['news:list_1_2']" label="待审核列表" name="1">
            <div class="text item">
              <el-row :gutter="24">
          ...
          <!-- 已发布列表 -->
          <el-tab-pane v-authority="['news:list_3']" label="已发布列表" name="3">
            <div class="text item">
              <el-row :gutter="24">
                <el-col :span="10">
                  <el-button class="filter-item" size="mini" round type="danger" icon="el-icon-delete" :loading="crud.delAllLoading" :disabled="crud.selections.length === 0" @click="toDelete(crud.selections)">删除</el-button>
