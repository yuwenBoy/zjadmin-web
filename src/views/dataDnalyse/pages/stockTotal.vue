        ...
        <el-row :gutter="24">
          <el-col :sm="12" :md="12" :xl="12" :lg="12" :xs="12">
            <div class="czy-home__widget">
              ...
              <div class="czy-home__widget-content">
                <column-chart :index="activeIndex" :xData="xData1" :seriesData="seriesData1" />
              </div>
          ...
          <el-col :sm="12" :md="12" :xl="12" :lg="12" :xs="12">
            <div class="czy-home__widget">
              ...
              <div class="czy-home__widget-content">
                <column-chart :index="activeIndex" :xData="xData2" :seriesData="seriesData2" />
              </div>
              <div class="czy-home__widget-footer">
                <div class="u-line-spacer"></div>
              </div>
        ...
        <el-row :gutter="24" style="margin-top:15px;">
          <el-col :sm="12" :md="12" :xl="12" :lg="12" :xs="12">
            <div class="czy-home__widget">
              ...
              <div class="czy-home__widget-content">
                <div style="width:100%;height:300px" ref="div3"></div>
              </div>
              <div class="czy-home__widget-footer">
                <div class="u-line-spacer"></div>
              </div>
          ...
          <el-col :sm="12" :md="12" :xl="12" :lg="12" :xs="12">
            <div class="czy-home__widget">
              ...
              <div class="czy-home__widget-content">
                <div style="width:100%;height:300px" ref="div4"></div>
              </div>
              <div class="czy-home__widget-footer">
                <div class="u-line-spacer"></div>
              </div>
